...
/** @dev Function to transfer funds to project creator
        ...
        nonReentrant()
    {
     ...
     // _withdrawalRequestIndex - 1 to accomodate 0 start of arrays
            ...
            idToWithdrawalRequests[_id][_withdrawalRequestIndex - 1].approvedVotes > (idToProject[_id].totalDepositors) / 2,
        ...
        uint256 platformFee = (cRequest.withdrawalAmount * (3)) / 1000;
